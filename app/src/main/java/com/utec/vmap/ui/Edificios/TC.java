...
public class TC {
    private static final String TAG = TC.class.getName();
    ...
    private final MSV view;
    private final MR mRenderer;
    ...
    public synchronized boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (pointerCount == 1) {
            ...
            rotation = 0;
            rotation = TS.getRotation360(motionEvent);
            currentSquare = TS.getSquare(motionEvent);
