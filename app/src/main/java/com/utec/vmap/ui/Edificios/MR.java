...
public class MR implements GLSurfaceView.Renderer {
    private final static String TAG = MR.class.getName();
    /**
    ...
    public MR(MSV ms)throws IllegalAccessException, IOException
    {
        this.main = ms;
        // This component will draw the actual models using OpenGL
        drawer = new DrawerFactory(ms.getContext());
    }
    ...
    public void onSurfaceCreated(GL10 unused, EGLConfig config) {
        ...
        float[] backgroundColor = new float[]{0f, 0f, 0f, 1.0f};;
